...
public class Application {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String username   = System.getenv("PARETO_BUILD_USERNAME");
    String password   = System.getenv("PARETO_BUILD_PASSWORD");
    String buildFile  = System.getenv("PARETO_BUILD_FILE");
    String factoryURL = System.getenv("PARETO_BUILD_FACTORY_URL");
    String tokenURL   = System.getenv("PARETO_BUILD_TOKEN_URL");
    ...
    if (StringUtils.isEmpty(tokenURL)) {
      logger.error("Null or empty Access Token URL. Set environment variable: PARETO_BUILD_TOKEN_URL. Terminating...");
      System.exit(1);
    }    
